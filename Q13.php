...
<body>
    ...
    <div class="container">
        ...
        $question_text = "13. Tech companies are investing enough in research and development to address issues of racial and gender inequality in technology.";
        ...
        <?php
            ...
            if (!empty($_POST['answer'])) {
                echo '<form method="post" action="Q12.php">';
