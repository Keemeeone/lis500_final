...
<body>
    ...
    <div class="container">
        ...
        $question_text = "15. Developers and programmers have a responsibility to consider the potential social and ethical implications of their code.";
        ...
        <?php
            ...
            if (!empty($_POST['answer'])) {
                echo '<form method="post" action="Q14.php">';
