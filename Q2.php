...
<body>
    ...
    <div class="container">
        ...
        $question_text = "2. There is enough representation of people of different races in positions of power and influence.";
        ...
        <form method="post" action="Q3.php">
            <?php echo '<h1>'."Understanding Race".'</h1>'; ?>
            ...
            if (!empty($_POST['answer'])) {
                echo '<form method="post" action="Q1.php">';
