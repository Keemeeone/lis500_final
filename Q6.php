...
<body>
    ...
    <div class="container">
        ...
        $question_text = "6. There are enough resources available to support people of color and women in their pursuit of education and career goals.";
        ...
        <form method="post" action="Q7.php">
            <?php echo '<h1>'."Understanding Race and Gender".'</h1>'; ?>
        ...
        <?php
            ...
            if (!empty($_POST['answer'])) {
                echo '<form method="post" action="Q6.php">';
