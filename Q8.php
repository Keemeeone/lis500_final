...
<body>
    ...
    <div class="container">
        ...
        $question_text = "8. There is enough representation of people of all genders in leadership positions.";
        ...
        <form method="post" action="Q9.php">
            <?php echo '<h1>'."Understanding Gender".'</h1>'; ?>
        ...
        <?php
            ...
            if (!empty($_POST['answer'])) {
                echo '<form method="post" action="Q7.php">';
